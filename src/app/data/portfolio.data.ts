...
export const PORTFOLIO_DATA: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      type: 'Enterprise insurance platform & micro-frontend development',
      description:
        'A confidential enterprise insurance operations platform connecting call centers, claims teams, assessors, repair shops, recovery departments, surveyors, and administrative users. The platform supports the insurance lifecycle from notification intake and policy verification through assessment, claim resolution, payments, recovery, document management, and operational reporting.',
      technologies: [
        'Angular 17',
        'TypeScript',
        'RxJS',
      ...
      responsibilities: [
        'Developed and maintained Angular micro frontends using Native Federation, standalone components, shared libraries, and reusable enterprise UI patterns.',
        'Delivered complex workflows for call-center operations, claims resolution, assessments, surveys, repair shops, recovery, data management, and administration.',
        'Built API-driven forms, configurable dashboards, advanced tables, file viewers and uploads, document workflows, maps, charts, dialogs, and role-aware actions.',
        'Implemented JWT authentication, refresh-token handling, HTTP interceptors, centralized error handling, session management, and granular authorization.',
        'Supported responsive multilingual and RTL interfaces while improving performance, maintainability, and production stability.',
      ],
      highlights: [
        '15 independently developed Angular applications supported by reusable shared libraries',
        'End-to-end insurance notification and claims lifecycle',
        'Native Federation micro-frontend architecture',
        'Permission-driven workflows across multiple operational departments',
        'Centralized authentication, error handling, document management, and shared UI',
        'Responsive multilingual and RTL enterprise experience',
      ],
      githubUrl: null,
      liveUrl: null,
      image: null,
